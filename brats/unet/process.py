...
DEFAULT_ALGORITHM_OUTPUT_FILE_PATH = Path("/home/lchalcroft/mdunet/lka_paper_dockers/brats/unet/tumour-segmentation/results.json")
...
class ploras:
    def __init__(
        ...
        if self.debug:
            ...
            self._output_path = Path(
                "/home/lchalcroft/mdunet/lka_paper_dockers/brats/unet/tumour-segmentation"
            )
        ...
        args = SimpleNamespace(
            exec_mode="predict",
            data="/home/lchalcroft/mdunet/lka_paper_dockers/brats/unet/data/11_3d/test",
            results="/home/lchalcroft/mdunet/lka_paper_dockers/brats/unet/results",
            config="/home/lchalcroft/mdunet/lka_paper_dockers/brats/unet/configs/config.pkl",
            logname="ploras",
            task="11",
            gpus=1,
            nodes=1,
            ...
            val_epochs=10,
            ckpt_path=None,
            ckpt_store_dir="/home/lchalcroft/mdunet/lka_paper_dockers/brats/unet/checkpoints/",
            fold=0,
            patience=100,
            batch_size=4,
            val_batch_size=4,
        ...
        self.model_paths = ["/home/lchalcroft/mdunet/lka_paper_dockers/brats/unet/checkpoints/0/last.ckpt"]
        self.args = []
        for i, pth in enumerate(self.model_paths):
            ...
            ckpt["hyper_parameters"][
                "args"
            ].ckpt_store_dir = "/home/lchalcroft/mdunet/lka_paper_dockers/brats/unet/checkpoints/" + str(i)
            ckpt["hyper_parameters"]["args"].ckpt_path = (
                "/home/lchalcroft/mdunet/lka_paper_dockers/brats/unet/checkpoints/" + str(i) + "/last.ckpt"
            )
    ...
    def nnunet_preprocess(self, image):
        ...
        args = SimpleNamespace(
            data="/home/lchalcroft/mdunet/lka_paper_dockers/brats/unet/data",
            results="/home/lchalcroft/mdunet/lka_paper_dockers/brats/unet/data",
            exec_mode="test",
            ohe=True,
            verbose=False,
            task="11",
    ...
    def nnunet_infer(self, args):
        ...
        save_dir = os.path.join("/home/lchalcroft/mdunet/lka_paper_dockers/brats/unet/prediction", str(args.fold))
    ...
    def setup(self):
        os.makedirs("/home/lchalcroft/mdunet/lka_paper_dockers/brats/unet/data", exist_ok=True)
        os.makedirs("/home/lchalcroft/mdunet/lka_paper_dockers/brats/unet/results", exist_ok=True)
        os.makedirs("/home/lchalcroft/mdunet/lka_paper_dockers/brats/unet/prediction", exist_ok=True)

    def cleanup(self):
        shutil.rmtree("/home/lchalcroft/mdunet/lka_paper_dockers/brats/unet/data", ignore_errors=True)
        shutil.rmtree("/home/lchalcroft/mdunet/lka_paper_dockers/brats/unet/results", ignore_errors=True)
        shutil.rmtree("/home/lchalcroft/mdunet/lka_paper_dockers/brats/unet/prediction", ignore_errors=True)
    ...
    def process(self):
        ...
        for fil in file_list:
            ...
            paths = [
                os.path.join(
                    "/home/lchalcroft/mdunet/lka_paper_dockers/brats/unet/prediction", str(i), "BraTS2021_0001.npy"
                )
...
if __name__ == "__main__":
    pathlib.Path("/home/lchalcroft/mdunet/lka_paper_dockers/brats/unet/tumour-segmentation").mkdir(
